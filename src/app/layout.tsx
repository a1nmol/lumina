...
// Display serif — wired to `--font-heading` (globals.css). Used sparingly:
// page-hero headlines, big Command Center stat numerals, empty-state
// headlines, celebration moments. Only weight 400 exists for this family.
