...
/**
 * Internal dev tool — NOT linked from any nav. Visit directly at
 * /wick-preview to eyeball every Wick state side by side. Safe to delete
 * once Wick has enough real call-sites to review in context instead.
 */
...
export default function WickPreviewPage() {
