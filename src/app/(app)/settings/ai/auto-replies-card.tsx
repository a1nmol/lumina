...
// "AI auto-replies" card — Settings hub -> AI behaviour. Org-wide default for
// new FrontDesk conversations (migration 0011 `business_brain.
// frontdesk_auto_reply`). Sets the starting `ai_mode` ('auto' vs 'off') new
// conversations are created with in src/app/api/frontdesk/chat/route.ts and
...
// "AI auto-replies for new conversations" card that also carried the Honest-
// AI intro and Always-on blocks — see ./ai-intro-card.tsx and
// ./always-on-card.tsx for the other two. Behavior here is unchanged, just
// its own honestly-scoped card.
...
export function AutoRepliesCard({ initialEnabled, isLive, className }: AutoRepliesCardProps) {
